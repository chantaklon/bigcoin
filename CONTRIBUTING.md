Contributing to BIG Core
============================

The BIG Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BIG Core project, and is not to be
confused with overall BIG Network Protocol consensus changes.

Whether a pull request is merged into BIG Core rests with the project merge
...
Patches that change BIG consensus rules are considerably more involved than
...
Where a patch set proposes to change the BIG consensus, it must have been
...
The project leader is the release manager for each BIG Core release.
