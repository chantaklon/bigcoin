                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BIG from zBIG"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBIG"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBIG));
