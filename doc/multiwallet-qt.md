...
In order to support loading of multiple wallets in big-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is big.cpp.
...
Changes to big.cpp
----------------------
big.cpp is the entry point into big-qt, and as such, will require some minor modifications to provide hooks for
