                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BIG Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BIG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and big: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBIG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BIG Core"), this);
    aboutAction->setStatusTip(tr("Show information about BIG Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BIG"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BIG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BIG addresses"));
    ...
    openAction->setStatusTip(tr("Open a BIG: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BIG Core help message to get a list with possible BIG command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BIG Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BIG network", "", count));
}
...
{
    QString strTitle = tr("BIG Core"); // default title
